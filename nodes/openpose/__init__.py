...
devices = namedtuple("device", ["get_device_for"])(get_device_for=lambda x: "cuda:0")
...
class OpenposeDetector:
    ...
    def __call__(
            ...
            use_dw_pose=False, json_pose_callback: Callable[[str], None] = None, **kargs
        ):
        """
        ...
        """
        print("for dwpose image type", type(oriImg))
        H, W, *_ = oriImg.shape
